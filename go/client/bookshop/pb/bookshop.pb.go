...
type GetBookDetailByIdRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBookDetailByIdRequest) Reset() {
	*x = GetBookDetailByIdRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBookDetailByIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBookDetailByIdRequest) ProtoMessage() {}

func (x *GetBookDetailByIdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_bookshop_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBookDetailByIdRequest.ProtoReflect.Descriptor instead.
func (*GetBookDetailByIdRequest) Descriptor() ([]byte, []int) {
	return file_bookshop_proto_rawDescGZIP(), []int{3}
}

func (x *GetBookDetailByIdRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
type GetBookDetailByIdResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BookDetail *Book `protobuf:"bytes,1,opt,name=bookDetail,proto3" json:"bookDetail,omitempty"`
}

func (x *GetBookDetailByIdResponse) Reset() {
	*x = GetBookDetailByIdResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBookDetailByIdResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBookDetailByIdResponse) ProtoMessage() {}

func (x *GetBookDetailByIdResponse) ProtoReflect() protoreflect.Message {
	mi := &file_bookshop_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBookDetailByIdResponse.ProtoReflect.Descriptor instead.
func (*GetBookDetailByIdResponse) Descriptor() ([]byte, []int) {
	return file_bookshop_proto_rawDescGZIP(), []int{4}
}

func (x *GetBookDetailByIdResponse) GetBookDetail() *Book {
	if x != nil {
		return x.BookDetail
	}
	return nil
...
var file_bookshop_proto_rawDesc = []byte{
	...
	,
...
var file_bookshop_proto_goTypes = []interface{}{
	...
	(*GetBookDetailByIdRequest)(nil),  // 3: GetBookDetailByIdRequest
	(*GetBookDetailByIdResponse)(nil), // 4: GetBookDetailByIdResponse
}
var file_bookshop_proto_depIdxs = []int32{
	0, // 0: GetBookListResponse.books:type_name -> Book
	0, // 1: GetBookDetailByIdResponse.bookDetail:type_name -> Book
	1, // 2: Inventory.GetBookList:input_type -> GetBookListRequest
	3, // 3: Inventory.GetBookDetailById:input_type -> GetBookDetailByIdRequest
	2, // 4: Inventory.GetBookList:output_type -> GetBookListResponse
	4, // 5: Inventory.GetBookDetailById:output_type -> GetBookDetailByIdResponse
...
func file_bookshop_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bookshop_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBookDetailByIdRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bookshop_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBookDetailByIdResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
