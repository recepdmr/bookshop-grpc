...
type InventoryClient interface {
	...
	GetBookDetailById(ctx context.Context, in *GetBookDetailByIdRequest, opts ...grpc.CallOption) (*GetBookDetailByIdResponse, error)
}
...
func (c *inventoryClient) GetBookDetailById(ctx context.Context, in *GetBookDetailByIdRequest, opts ...grpc.CallOption) (*GetBookDetailByIdResponse, error) {
	out := new(GetBookDetailByIdResponse)
	err := c.cc.Invoke(ctx, "/Inventory/GetBookDetailById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServer interface {
	...
	GetBookDetailById(context.Context, *GetBookDetailByIdRequest) (*GetBookDetailByIdResponse, error)
...
func (UnimplementedInventoryServer) GetBookDetailById(context.Context, *GetBookDetailByIdRequest) (*GetBookDetailByIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBookDetailById not implemented")
}
...
func _Inventory_GetBookDetailById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookDetailByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServer).GetBookDetailById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Inventory/GetBookDetailById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).GetBookDetailById(ctx, req.(*GetBookDetailByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBookDetailById",
			Handler:    _Inventory_GetBookDetailById_Handler,
		},
	},
